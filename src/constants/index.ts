...
export const sarahProgram: UserProgram = {
  id: 1,
  first_name: "Sarah",
...
export const michaelProgram: UserProgram = {
  id: 2,
  first_name: "Michael",
...
export const elenaProgram: UserProgram = {
  id: 3,
  first_name: "Elena",
...
export const USER_PROGRAMS = [sarahProgram, michaelProgram, elenaProgram];
